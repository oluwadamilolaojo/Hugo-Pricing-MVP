...
const SERVICE_DESCRIPTIONS: Record<string, string> = {
  ...
  'Back Office Specialized T1': 'Back office requiring meaningful domain context — not just following a process but understanding the field. Examples: healthcare admin, insurance processing, financial services data work.',
              ...
              {isBelowFloor && (
                <div className="mt-1 bg-amber-950/20 border border-amber-600/30 rounded-xl p-4">
                  ...
                  <div className="text-[10px] text-amber-400/70 mb-3">
                    Proposed rate ({fmt(inputs.proposedRate)}/hr) is below the floor rate ({fmt(floorPL!.floorRate)}/hr).
